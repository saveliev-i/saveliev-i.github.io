...
var renderer = new THREE.WebGLRenderer({ canvas: document.getElementById('C0anvas'), antialias: true });
...
var circlematerial = new THREE.MeshStandardMaterial({ color: 0x098877, roughness: 0.0, metalness: 0.2 });
